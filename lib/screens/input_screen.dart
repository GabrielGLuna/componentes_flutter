...
String toString() {
  ...
  Opción del checkbox 1: $checkBoxOption1
  Opción del checkbox 2: $checkBoxOption2
  Opción del checkbox 3: $checkBoxOption3
''';
}
}
        ...
        child: Column(
          ...
          children: [
              ...
              ElevatedButton(
                ...
                child: Text('Enviar',style: AppTheme.lightTheme.textTheme.labelLarge),
              )
          ],
        ),
      ),
